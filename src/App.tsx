...
import PlanoSaudeColetivo from "./pages/PlanoSaudeColetivo";
...
import SeguroFrotas from "./pages/SeguroFrotas";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/coletivo-por-adesao" element={<PlanoSaudeColetivo />} />
          ...
          <Route path="/seguro-frotas" element={<SeguroFrotas />} />
