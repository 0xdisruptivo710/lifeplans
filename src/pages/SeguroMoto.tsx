...
import { Bike, Check, Shield, Wrench } from "lucide-react";
...
const SeguroMoto = () => {
  const benefits = [
    ...
    "Proteção especial para capacetes e equipamentos",
        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            ...
            <p className="text-gray-light text-xl font-extralight leading-relaxed mb-8">
              Proteção completa para sua motocicleta com as melhores seguradoras. 
              Pilote com tranquilidade sabendo que está protegido.
            </p>
            <a href="https://wa.me/551541412625?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20Seguro%20de%20Motos" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-gray-light text-lg font-extralight leading-relaxed mb-6">
                O seguro de moto é essencial para proteger seu patrimônio e garantir segurança no dia a dia. 
                Motociclistas enfrentam riscos específicos no trânsito, e ter uma cobertura adequada traz paz de espírito.
              </p>
              <p className="text-gray-light text-lg font-extralight leading-relaxed">
                Com a Lifeplans, você encontra as melhores opções do mercado com coberturas especializadas
                para motocicletas e preços competitivos para todos os perfis de motociclistas.
              </p>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black-primary p-8 border border-gray-dark hover:border-gold-accent transition-all duration-300">
              <Bike className="text-gold-accent mb-6" size={48} strokeWidth={1.5} />
              ...
              <p className="text-gray-medium font-extralight leading-relaxed">
                Proteção contra colisão, roubo, furto, incêndio e acidentes específicos de motos.
              </p>
            </div>
            <div className="bg-black-primary p-8 border border-gray-dark hover:border-gold-accent transition-all duration-300">
              ...
              <p className="text-gray-medium font-extralight leading-relaxed">
                Guincho especializado, chaveiro, pane elétrica e mecânica em todo Brasil.
              </p>
            </div>
            <div className="bg-black-primary p-8 border border-gray-dark hover:border-gold-accent transition-all duration-300">
              <Wrench className="text-gold-accent mb-6" size={48} strokeWidth={1.5} />
              <h3 className="text-white text-2xl font-light mb-4">Equipamentos</h3>
              <p className="text-gray-medium font-extralight leading-relaxed">
                Proteção especial para capacetes, jaquetas e acessórios da moto.
              </p>
            </div>
          </div>
        </div>
